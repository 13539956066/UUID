...
public class DbUtil {
  ...
  public <T> List<T> queryList(Connection connection, String sql, Class clazz, Map<String, Object> params)
      throws SQLException {
  ...
  public int update(Connection connection, String sql, Map<String, Object> params) throws SQLException {
  ...
  public int[] batch(Connection connection, String sql, Map<String, Object> params) throws SQLException {
  ...
  public <T> T executeTransaction(Connection connection, Transaction<T> transaction) throws Throwable {
